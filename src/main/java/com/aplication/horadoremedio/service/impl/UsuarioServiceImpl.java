...
public class UsuarioServiceImpl implements UsuarioService {
	...
	// vericar se usuario está presente caso não esteja retorna uma exception com
	// amensagem
	...
	public Usuario autenticar(String email, String senha) {
		...
		// se usuario existir, verificar se a senha corresponde a senha casdatrada no
		// email do uusario
	...
	// caso o email já esteja cadastrado dispara uma exceção com a mensagem email em
	// uso.
	@Override
